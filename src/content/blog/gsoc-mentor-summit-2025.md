...
tags:
  ...
  - mentor summit
ogImage: ""
description: My experience attending the GSoC Mentor Summit 2025 and insights from sessions on OSS, contributors, and AI's influence on the program.
---
...
![GSoC Mentor Summit](/assets/mentor_summit_2025.jpg)
...
There was a segment about using RAG to improve the context for the used LLM which I personally think [Cursor](https://cursor.com/) does a very good job at.
...
- Allowing candidates to add their GitHub profile link while filling out the application.
- Allowing orgs to create pre-requisite list which then the org admins can tick off against each application; and the mentors would be able to see the selections.
- There was some talk about AI spam detection (but there was no certainty about this thing happening).
...
- [Notion](https://notion.so/) for taking notes or jotting any kind of info
- [Excalidraw](https://excalidraw.com/) for making great diagrams
- [Coverity](https://scan.coverity.com/) for static code analysis
- [Zenhub](https://www.zenhub.com/) turns out it turns GitHub into a Kanban board

The [session notes](https://docs.google.com/document/d/19bRaPvepq735wBrYg99YY-ks0QthCx-T6Po7VxH5gbQ/edit?tab=t.0) have a complete list of the tools that were discussed.
